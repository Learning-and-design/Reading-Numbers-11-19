...
const scriptsInEvents = {
		...
		async Es_common_Event200_Act1(runtime, localVars)
		{
		...
		async Es_common_Event201_Act4(runtime, localVars)
		{
			AppInterface.sendToApp(runtime.getInstanceByUid(5378).getJsonDataCopy());
		},

		async Es_common_Event202_Act1(runtime, localVars)
		{
			localStorage.setItem(runtime.globalVars.LOCAL_GAME_KEY, JSON.stringify(runtime.getInstanceByUid(runtime.globalVars.JSON_UID).getJsonDataCopy()));
