...
const scriptsInEvents = {
		...
		async Es_level3_Event58_Act4(runtime, localVars)
		{
			let data = JSON.parse(localStorage.getItem(runtime.globalVars.LOCAL_GAME_KEY));
			runtime.globalVars.RewardPoints = data.totalRewards;
			runtime.getInstanceByUid(runtime.globalVars.JSON_UID).setJsonDataCopy(data);
		...
		async Es_level4_Event103_Act5(runtime, localVars)
		{
			let data = JSON.parse(localStorage.getItem(runtime.globalVars.LOCAL_GAME_KEY));
			runtime.globalVars.RewardPoints = data.totalRewards;
			runtime.getInstanceByUid(runtime.globalVars.JSON_UID).setJsonDataCopy(data);
		...
		async Es_common_Event52_Act1(runtime, localVars)
		{
			
			const nextLevel = runtime.globalVars.CurrentLevel <runtime.globalVars.TotalLevels?runtime.globalVars.CurrentLevel+1:1;
		...
		async Es_common_Event201_Act48(runtime, localVars)
		{
