	...
	if(messageData){
        ...
        if(runtime.globalVars.isGameCompleted)
        {
            ...
            if(runtime.globalVars.GameLevel == 0){
                runtime.globalVars.L0_TutorialDone =messageData.levelDetails.currentLevel.presentationCompleted
             //remaining are false by default
            }
            else if(runtime.globalVars.GameLevel == 1){
                
                runtime.globalVars.L1_TutorialDone = messageData.levelDetails.currentLevel.presentationCompleted	
                runtime.globalVars.L0_TutorialDone = 1;
                }
            else if(runtime.globalVars.GameLevel == 2){
                runtime.globalVars.L2_TutorialDone = messageData.levelDetails.currentLevel.presentationCompleted;
                runtime.globalVars.L1_TutorialDone = 1;			
                runtime.globalVars.L0_TutorialDone = 1;
                
                runtime.globalVars.L1_Completed = 1;
                }
            else if(runtime.globalVars.GameLevel == 3){
                runtime.globalVars.L3_TutorialDone = messageData.levelDetails.currentLevel.presentationCompleted
                runtime.globalVars.L2_TutorialDone = 1;
                runtime.globalVars.L1_TutorialDone = 1;
                runtime.globalVars.L0_TutorialDone = 1;
                ...
                runtime.globalVars.L3_TutorialDone = 1;
                runtime.globalVars.L2_TutorialDone = 1;
                runtime.globalVars.L1_TutorialDone = 1;						
                runtime.globalVars.L0_TutorialDone = 1;
